...
| Regime | Score |
| --- | ---: |
| Selective Capital Re-entry | 168 |
| Developer Strategy Shift | 123 |
| Financing Stress | 92 |
| Supply Pressure | 43 |
...
| Construction Cost Pressure | 11 | Not Detected |
| Stable Monitoring Environment | 0 | Not Detected |

## Signal Inputs

- Strategy-briefing articles reviewed: 49
...
- Developer Strategy: 23
- Financing Risk: 15
- Regulation Risk: 4
- Supply Pressure: 4
- Rent Growth / Demand: 1
...
- High relevance to US residential developer strategy: 39
- Medium relevance to market monitoring: 10

## Key Thematic Context

- Institutional Flow is Moderate Increase (20 to 24).
- Market signal activity is increasing, led by Rent Growth Signal (8 to 10).

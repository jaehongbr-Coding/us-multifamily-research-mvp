...
Generated: 2026-07-06 00:06:55

## Detected Regime

- Primary regime: Developer Strategy Shift
- Secondary regime: Financing Stress
...
| Regime | Score |
| --- | ---: |
| Developer Strategy Shift | 172 |
| Financing Stress | 114 |
| Selective Capital Re-entry | 81 |
| Supply Pressure | 44 |
...
| Supply Pressure | 29 | Weak |
| Construction Cost Pressure | 3 | Not Detected |
| Stable Monitoring Environment | 0 | Not Detected |

## Signal Inputs

- Strategy-briefing articles reviewed: 48
- Market-signal articles reviewed: 31
- Articles with extracted numbers: 31
- Institutional player mentions: 5

### Strategic Angles

- Developer Strategy: 34
- Financing Risk: 20
- Institutional Flow: 11
- Regulation Risk: 4

### Market Signals

- Supply / Starts Signal: 13
...
- Track Developer Strategy: 34
- Track Financing Conditions: 20
- Track Institutional Capital Flow: 11
...
- High relevance to US residential developer strategy: 45
- Medium relevance to market monitoring: 3

## Key Thematic Context

- California focus is Moderate Increase (3 to 4).
- Institutional Flow is Moderate Increase (9 to 11).
- Market signal activity is increasing, led by Deal Size Signal (5 to 6).

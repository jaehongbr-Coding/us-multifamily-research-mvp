...
- PASS | expected Development Activity | actual Development Activity | NRP Group Breaks Ground on 336-Unit Affordable Housing Project in Southeast Austin | anchor=True | reason=development_project_anchor: capital event with identifiable project/asset (unit/site count: 336-unit; execution milestone: breaks ground; project/asset term: project)

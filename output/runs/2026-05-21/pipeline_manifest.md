...
|---|---|---|---|---:|---|
| `articles.csv` | CSV | Raw Collection | Generated | 86 | Strategy Team |
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 55 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 37 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 63 | Executive |
| `daily_strategy_briefing.md` | Markdown | Strategy Briefing | Generated | 199 | Executive |
...
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 34 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 154 | Strategy Team |
...
| `opportunity_radar.csv` | CSV | Opportunity / Distress | Generated | 63 | Investment Team |
| `distress_watchlist.csv` | CSV | Opportunity / Distress | Generated | 8 | Investment Team |
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 70 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 98 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 57 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 765 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 154 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 91 | US Local Team |
| `entitlement_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 16 | Development Team |
| `la_entitlement_watch.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 11 | US Local Team |
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 98 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 98 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 53 | Strategy Team |
| `market_entry_window.csv` | CSV | Strategy Briefing | Generated | 8 | Investment Team |
| `gp_watchlist.csv` | CSV | GP / Institutional Intelligence | Generated | 9 | Strategy Team |
| `gp_intelligence.csv` | CSV | GP / Institutional Intelligence | Generated | 9 | Strategy Team |
| `institutional_relationships.csv` | CSV | GP / Institutional Intelligence | Generated | 9 | Strategy Team |
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 124 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 526 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 128 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 177 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 650 | Technical / Maintenance |

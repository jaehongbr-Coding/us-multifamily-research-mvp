...
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 48 | Executive |
...
| `signal_quality.csv` | CSV | Quality Control | Generated | 188 | Strategy Team |
...
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 67 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 98 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 66 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 786 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 188 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 127 | US Local Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 7049 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 1520 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 1956 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 2745 | Technical / Maintenance |

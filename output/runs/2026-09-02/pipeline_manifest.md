...
|---|---|---|---|---:|---|
| `articles.csv` | CSV | Raw Collection | Generated | 83 | Strategy Team |
...
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 46 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 177 | Strategy Team |
...
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 64 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 93 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 57 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 736 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 177 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 118 | US Local Team |
...
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 93 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 93 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 41 | Strategy Team |
| `market_entry_window.csv` | CSV | Strategy Briefing | Generated | 8 | Investment Team |
| `gp_watchlist.csv` | CSV | GP / Institutional Intelligence | Generated | 25 | Strategy Team |
| `gp_intelligence.csv` | CSV | GP / Institutional Intelligence | Generated | 25 | Strategy Team |
| `institutional_relationships.csv` | CSV | GP / Institutional Intelligence | Generated | 25 | Strategy Team |
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 127 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 8225 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 1729 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 2259 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 3006 | Technical / Maintenance |

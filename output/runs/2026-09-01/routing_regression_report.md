...
- PASS | expected Development Activity | actual Development Activity | Waterford Property Co. Breaks Ground on Affordable Housing Project in Milpitas, California | anchor=True | reason=development_project_anchor: capital event with identifiable project/asset (unit/site count: 75-unit; execution milestone: breaks ground; project/asset term: project)

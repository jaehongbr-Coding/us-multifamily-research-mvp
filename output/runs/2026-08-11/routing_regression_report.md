...
- PASS | expected Development Activity | actual Development Activity | Serenity Gardens Breaks Ground to Deliver 153 Affordable Senior Units Housing in Miami | anchor=True | reason=development_project_anchor: capital event with identifiable project/asset (execution milestone: breaks ground; project/asset term: project)

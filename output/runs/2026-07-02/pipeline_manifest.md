...
|---|---|---|---|---:|---|
| `articles.csv` | CSV | Raw Collection | Generated | 87 | Strategy Team |
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 46 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 33 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 51 | Executive |
...
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 45 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 194 | Strategy Team |
...
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 103 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 65 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 824 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 194 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 125 | US Local Team |
| `entitlement_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 14 | Development Team |
| `la_entitlement_watch.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 12 | US Local Team |
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 102 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 102 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 39 | Strategy Team |
| `market_entry_window.csv` | CSV | Strategy Briefing | Generated | 8 | Investment Team |
| `gp_watchlist.csv` | CSV | GP / Institutional Intelligence | Generated | 29 | Strategy Team |
| `gp_intelligence.csv` | CSV | GP / Institutional Intelligence | Generated | 29 | Strategy Team |
| `institutional_relationships.csv` | CSV | GP / Institutional Intelligence | Generated | 29 | Strategy Team |
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 151 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 3610 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 809 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 1080 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 2051 | Technical / Maintenance |

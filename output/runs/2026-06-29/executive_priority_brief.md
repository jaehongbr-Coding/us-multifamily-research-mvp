...
| 5 | Policy / Entitlement Watch | 74 | Tier 3 Monitoring | Development Team; US Local Team; Strategy Team | Next IC / Strategy Meeting |
...
- Rank 5: Policy / Entitlement Watch (74). Policy and entitlement signals should be monitored because they may affect approvals, zoning strategy, and local development feasibility. Owner: Development Team; US Local Team; Strategy Team. Timing: Next IC / Strategy Meeting.
...
- S3 Capital: Immediate Watch, refinancing; office-to-residential conversion; JV / partnership; operational technology / AI adoption, monitor JV activity.
- Tishman Speyer: Immediate Watch, JV / partnership; capital raise; operational technology / AI adoption, monitor JV activity.
...
- Camden Property Trust: GP Capability Benchmark Signal, Capital Inflow, score 98.

## Deal / Project Pipeline Context

Deal and project extraction is available in `deal_pipeline_report.md`.
- Disposition / Exit in Nashville / Tennessee: Underwriting benchmark (High Deal Intelligence).
...
- GID -> fannie mae: Financing Relationship (Relevant to capital markets monitoring).
...
- Duplicate project clusters: 125
...
- Recommended focus: Review Refinancing - San Francisco / California - Mesa West Capital Joint Venture Provides $83M for Seattle Multifamily Apartment Community... and related high-confidence project signals.

...
- Houston (Texas): submarket_opportunity_score 100, Review potential acquisition pipeline.
...
- Chinatown (Los Angeles): submarket_opportunity_score 68, Monitor entitlement precedent.

## Top Submarkets By Risk Score

- New York (New York): submarket_risk_score 94, Monitor entitlement precedent.
...
- Seattle (Seattle): execution_complexity_score 30, Monitor entitlement precedent.
- Venice (Los Angeles): execution_complexity_score 30, Monitor entitlement precedent.
- Chinatown (Los Angeles): execution_complexity_score 30, Monitor entitlement precedent.
...
- Houston: Apartment, Transit-oriented development.
- Los Angeles: Affordable Housing, Adaptive reuse corridor.
...
- Chinatown: Affordable Housing, Mixed-use corridor.
...
- New York: 10 timing signal(s), 3 entitlement signal(s).
- Houston: 3 timing signal(s), 0 entitlement signal(s).
...
- Seattle: 2 timing signal(s), 1 entitlement signal(s).
- Miami: 2 timing signal(s), 0 entitlement signal(s).
- Wilshire: 2 timing signal(s), 1 entitlement signal(s).
- Venice: 1 timing signal(s), 1 entitlement signal(s).
- Chinatown: 1 timing signal(s), 1 entitlement signal(s).
...
- Monitor entitlement precedent: Seattle (Strategic watch submarket).

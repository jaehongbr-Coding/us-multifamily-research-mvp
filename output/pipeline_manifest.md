...
- Total tracked outputs: 60
- Generated outputs: 60
- Missing outputs: 0
...
|---|---|---|---|---:|---|
| `articles.csv` | CSV | Raw Collection | Generated | 88 | Strategy Team |
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 52 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 38 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 61 | Executive |
| `daily_strategy_briefing.md` | Markdown | Strategy Briefing | Generated | 190 | Executive |
...
| `dashboard_cards.csv` | CSV | Executive Dashboard | Generated | 37 | Technical / Maintenance |
| `dashboard_watchlists.csv` | CSV | Executive Dashboard | Generated | 92 | Technical / Maintenance |
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 25 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 141 | Strategy Team |
| `source_health.csv` | CSV | Source Management | Generated | 152 | Technical / Maintenance |
...
| `source_activation.csv` | CSV | Source Management | Generated | 152 | Technical / Maintenance |
...
| `opportunity_radar.csv` | CSV | Opportunity / Distress | Generated | 64 | Investment Team |
| `distress_watchlist.csv` | CSV | Opportunity / Distress | Generated | 13 | Investment Team |
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 70 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 95 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 43 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 719 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 141 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 64 | US Local Team |
| `entitlement_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 10 | Development Team |
| `la_entitlement_watch.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 7 | US Local Team |
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 95 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 95 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 56 | Strategy Team |
| `market_entry_window.csv` | CSV | Strategy Briefing | Generated | 8 | Investment Team |
| `gp_watchlist.csv` | CSV | GP / Institutional Intelligence | Generated | 4 | Strategy Team |
| `gp_intelligence.csv` | CSV | GP / Institutional Intelligence | Generated | 4 | Strategy Team |
| `institutional_relationships.csv` | CSV | GP / Institutional Intelligence | Generated | 4 | Strategy Team |
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 118 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 418 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 107 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 140 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 520 | Technical / Maintenance |

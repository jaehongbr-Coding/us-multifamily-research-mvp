...
|---|---|---|---|---:|---|
| `articles.csv` | CSV | Raw Collection | Generated | 75 | Strategy Team |
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 52 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 31 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 57 | Executive |
| `daily_strategy_briefing.md` | Markdown | Strategy Briefing | Generated | 184 | Executive |
...
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 29 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 139 | Strategy Team |
...
| `opportunity_radar.csv` | CSV | Opportunity / Distress | Generated | 52 | Investment Team |
| `distress_watchlist.csv` | CSV | Opportunity / Distress | Generated | 11 | Investment Team |
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 59 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 83 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 51 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 653 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 139 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 88 | US Local Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 593 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 139 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 195 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 910 | Technical / Maintenance |

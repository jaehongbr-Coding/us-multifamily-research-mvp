...
- LRT Company Launches $21M DST Investment for Ground-Leased Multifamily Site Near Hilton Head Island South Carolina | Development Activity | site/parcel signal with project anchor: ground lease
- Seco Planning 12-Story, $100M FW Apartment Highrise | Development Activity | site/parcel signal with project anchor: to build
- Phase Three of The Tobin Estate Apartments Now Leasing in San Antonio | Development Activity | site/parcel signal with project anchor: acres + development/site signal
...
- BHI Provides Condo Inventory Loan for Ground-Up Luxury Project | GP / Capital Activity | rent_demand=No | property-level financing, lender, refinancing, or recapitalization signal detected
...
- Metro-adjacent affordable housing rises at 1640 20th Street in Santa Monica | Development Activity | rent_demand=No | development_project_anchor: Project / Asset (address/street: 1640 20th street; project/asset term: project)
- New plan unveiled for West Hollywood's Melrose Triangle development | Development Activity | rent_demand=No | development_project_anchor: Approval / Entitlement (address/street: 9060 santa monica boulevard; site/parcel signal: site; project/asset term: project; named asset/project hint: melrose triangle)
- Venice Dell affordable housing project notches legal win | Development Activity | rent_demand=No | development_project_anchor: Approval / Entitlement (project/asset term: project; named asset/project hint: venice dell)
- St. John Properties, Somerset Break Ground on $148M Multifamily Community in Baltimore County | Development Activity | rent_demand=No | development_project_anchor: Project / Asset (unit/site count: 000-acre; project/asset term: development)
- Berkadia Arranges $82.1M Refinancing for Apartment Community in Nokomis, Florida | Development Activity | rent_demand=No | development_project_anchor: project financing/capital event tied to project (unit/site count: 450-unit; address/street: 15560 render way; project/asset term: community)
...
- PASS | expected Development Activity | actual Development Activity | TCB Breaks Ground on 45-Unit Affordable Seniors Housing Project in Enfield, Connecticut | anchor=True | reason=development_project_anchor: Construction Start (unit/site count: 45-unit; execution milestone: breaks ground; project/asset term: project)

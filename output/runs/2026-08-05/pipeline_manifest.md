...
|---|---|---|---|---:|---|
| `articles.csv` | CSV | Raw Collection | Generated | 93 | Strategy Team |
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 61 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 45 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 66 | Executive |
...
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 57 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 204 | Strategy Team |
...
| `opportunity_radar.csv` | CSV | Opportunity / Distress | Generated | 70 | Investment Team |
| `distress_watchlist.csv` | CSV | Opportunity / Distress | Generated | 15 | Investment Team |
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 75 | Investment Team |
...
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 854 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 204 | Development Team |
...
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 103 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 103 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 65 | Strategy Team |
| `market_entry_window.csv` | CSV | Strategy Briefing | Generated | 8 | Investment Team |
| `gp_watchlist.csv` | CSV | GP / Institutional Intelligence | Generated | 34 | Strategy Team |
| `gp_intelligence.csv` | CSV | GP / Institutional Intelligence | Generated | 34 | Strategy Team |
| `institutional_relationships.csv` | CSV | GP / Institutional Intelligence | Generated | 34 | Strategy Team |
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 159 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 6188 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 1359 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 1732 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 2569 | Technical / Maintenance |

...
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 40 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 33 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 45 | Executive |
...
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 41 | Executive |
...
| `opportunity_radar.csv` | CSV | Opportunity / Distress | Generated | 51 | Investment Team |
| `distress_watchlist.csv` | CSV | Opportunity / Distress | Generated | 14 | Investment Team |
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 56 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 78 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 42 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 621 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 167 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 101 | US Local Team |
| `entitlement_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 7 | Development Team |
| `la_entitlement_watch.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 7 | US Local Team |
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 78 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 78 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 45 | Strategy Team |
...
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 114 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 3107 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 707 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 942 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 1966 | Technical / Maintenance |

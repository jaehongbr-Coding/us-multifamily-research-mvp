...
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 56 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 43 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 62 | Executive |
| `daily_strategy_briefing.md` | Markdown | Strategy Briefing | Generated | 221 | Executive |
...
| `dashboard_watchlists.csv` | CSV | Executive Dashboard | Generated | 96 | Technical / Maintenance |
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 36 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 157 | Strategy Team |
...
| `opportunity_radar.csv` | CSV | Opportunity / Distress | Generated | 65 | Investment Team |
| `distress_watchlist.csv` | CSV | Opportunity / Distress | Generated | 16 | Investment Team |
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 73 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 101 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 56 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 807 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 157 | Development Team |
...
| `la_entitlement_watch.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 12 | US Local Team |
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 101 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 101 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 60 | Strategy Team |
| `market_entry_window.csv` | CSV | Strategy Briefing | Generated | 8 | Investment Team |
| `gp_watchlist.csv` | CSV | GP / Institutional Intelligence | Generated | 8 | Strategy Team |
| `gp_intelligence.csv` | CSV | GP / Institutional Intelligence | Generated | 8 | Strategy Team |
| `institutional_relationships.csv` | CSV | GP / Institutional Intelligence | Generated | 8 | Strategy Team |
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 140 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 321 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 83 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 106 | Strategy Team |

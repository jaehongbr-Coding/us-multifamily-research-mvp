...
- PASS | expected Development Activity | actual Development Activity | Partnership Breaks Ground on 130-Unit Affordable Housing Community in Atlanta’s Buckhead District | anchor=True | reason=development_project_anchor: capital event with identifiable project/asset (unit/site count: 130-unit; execution milestone: breaks ground; project/asset term: development)

...
| Regime | Score |
| --- | ---: |
| Selective Capital Re-entry | 141 |
| Developer Strategy Shift | 141 |
| Financing Stress | 118 |
| Supply Pressure | 54 |
...
| Supply Pressure | 73 | Strong |
| Developer Strategy Shift | 59 | Moderate |
| Policy / Entitlement Watch | 39 | Weak |
| Construction Cost Pressure | 5 | Not Detected |
| Stable Monitoring Environment | 0 | Not Detected |

## Signal Inputs

- Strategy-briefing articles reviewed: 54
- Market-signal articles reviewed: 34
- Articles with extracted numbers: 34
...
- Deal Size Signal: 9
- Rent Growth Signal: 7
- Financing Cost Signal: 6
- Vacancy Signal: 2
...
- Medium relevance to market monitoring: 15

## Key Thematic Context

- Market signal activity is increasing, led by Financing Cost Signal (4 to 6).

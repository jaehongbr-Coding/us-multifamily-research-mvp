...
- PASS | expected Development Activity | actual Development Activity | Clear Blue Company Breaks Ground on Nashville-Area Multifamily Affordable Housing Project | anchor=True | reason=development_project_anchor: Construction Start (unit/site count: 228-unit; execution milestone: breaks ground; project/asset term: project)

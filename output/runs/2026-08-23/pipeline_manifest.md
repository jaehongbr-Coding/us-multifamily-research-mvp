...
|---|---|---|---|---:|---|
| `articles.csv` | CSV | Raw Collection | Generated | 71 | Strategy Team |
| `high_priority_articles.csv` | CSV | Strategy Briefing | Generated | 39 | Executive |
| `market_signals.csv` | CSV | Strategy Briefing | Generated | 27 | Strategy Team |
| `strategy_briefing.csv` | CSV | Strategy Briefing | Generated | 42 | Executive |
...
| `dashboard_watchlists.csv` | CSV | Executive Dashboard | Generated | 93 | Technical / Maintenance |
| `high_confidence_watchlist.csv` | CSV | Quality Control | Generated | 36 | Executive |
| `signal_quality.csv` | CSV | Quality Control | Generated | 146 | Strategy Team |
...
| `distress_watchlist.csv` | CSV | Opportunity / Distress | Generated | 6 | Investment Team |
| `deal_pipeline.csv` | CSV | Deal / Asset Intelligence | Generated | 55 | Investment Team |
| `asset_parcel_intelligence.csv` | CSV | Deal / Asset Intelligence | Generated | 75 | Development Team |
| `la_asset_watch.csv` | CSV | Deal / Asset Intelligence | Generated | 44 | US Local Team |
| `project_identity.csv` | CSV | Deal / Asset Intelligence | Generated | 596 | Technical / Maintenance |
| `persistent_asset_memory.csv` | CSV | Historical Memory | Generated | 146 | Development Team |
| `la_persistent_asset_watch.csv` | CSV | Historical Memory | Generated | 90 | US Local Team |
...
| `development_lifecycle.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 75 | Development Team |
| `lifecycle_transition.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 75 | Development Team |
| `timing_intelligence.csv` | CSV | Entitlement / Lifecycle Intelligence | Generated | 37 | Strategy Team |
| `market_entry_window.csv` | CSV | Strategy Briefing | Generated | 8 | Investment Team |
| `gp_watchlist.csv` | CSV | GP / Institutional Intelligence | Generated | 21 | Strategy Team |
| `gp_intelligence.csv` | CSV | GP / Institutional Intelligence | Generated | 21 | Strategy Team |
| `institutional_relationships.csv` | CSV | GP / Institutional Intelligence | Generated | 21 | Strategy Team |
| `relationship_graph.csv` | CSV | GP / Institutional Intelligence | Generated | 101 | Strategy Team |
...
| `historical_memory.csv` | CSV | Historical Memory | Generated | 7495 | Strategy Team |
| `capital_flow_memory.csv` | CSV | Historical Memory | Generated | 1605 | Finance / Treasury |
| `relationship_persistence.csv` | CSV | Historical Memory | Generated | 2070 | Strategy Team |
...
| `error_log.csv` | CSV | Quality Control | Generated | 2870 | Technical / Maintenance |

...
- Los Angeles: opportunity 100, risk 42, Monitor only.
- Santa Ana: opportunity 74, risk 59, Orange County suburban apartment watch.
- Koreatown: opportunity 73, risk 55, Koreatown multifamily watch.
- Glendale: opportunity 67, risk 30, Monitor only.
- Burbank: opportunity 58, risk 30, Monitor only.
- Echo Park: opportunity 56, risk 30, Monitor only.
...
- Review potential acquisition pipeline: Burbank / Monitor only.
- Review potential acquisition pipeline: Echo Park / Monitor only.
- Monitor only: California / Monitor only.
- Monitor only: Arts District / Monitor only.

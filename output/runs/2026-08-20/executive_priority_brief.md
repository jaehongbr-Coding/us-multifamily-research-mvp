...
- Wood Partners: Potential JV / Partnership Signal, Capital Inflow, score 99.

## Deal / Project Pipeline Context

Deal and project extraction is available in `deal_pipeline_report.md`.
- Acquisition in Colorado: Pricing benchmark (High Deal Intelligence).
...
- JLL -> freddie mac: Financing Relationship (Relevant to capital markets monitoring).
...
- Wood Partners: Tier 2 High Potential GP, score 76, Potential GP partnership candidate.
